...
"${FOLDSEEK}" base:result2profile "${QUERYDB}" "${TARGETDB}" "$RESULTS/results_aln" "$RESULTS/profile" --e-profile 0.001 --mask-profile 0 --sub-mat 'aa:blosum62.out,nucl:nucleotide.out'
