...
"${FOLDSEEK}" easy-multimersearch "$RESULTS/db" "$RESULTS/clusearchdb" "$RESULTS/aln" "$RESULTS/tmp" --chain-tm-threshold 0.5 --tmscore-threshold 0 --interface-lddt-threshold 0.3
...
TARGET="0.267284 73.9036 31.972 0.76286 107"
