...
"${FOLDSEEK}" easy-multimersearch "$RESULTS/db" "$RESULTS/clusearchdb" "$RESULTS/aln" "$RESULTS/tmp" --chain-tm-threshold 0.5 --multimer-tm-threshold 0 --interface-lddt-threshold 0.3 --cov-mode 1 --no-filter 0
