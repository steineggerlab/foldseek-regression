...
run_test run_search_lol "run_search_lol.sh"
...
run_test run_subdb_eash_complex_search "run_subdb_eash_complex_search.sh"
run_test run_subdb_eash_complex_cluster "run_subdb_eash_complex_cluster.sh"
run_test run_easy_complex_cluster "run_easy_complex_cluster.sh"
set -e
printf "\n"
ERR=0
for i in ${TESTS} ; do
